...
"""Dados BR gratis (sem chave).
  ...
  br.py bancos itau
  br.py ncm "camisa"
  br.py isbn 9788535902778
  br.py pix nubank
  br.py dominio meusite.com.br
  br.py cambio USD
"""
import sys, requests
...
# A BrasilAPI entrega bem mais que CEP/CNPJ/feriados sem exigir chave: os
# extras abaixo ficam aqui, no arquivo que ja fala com essa API, em vez de
# virar arquivo novo (e a mesma fonte).
def ddd(d):
